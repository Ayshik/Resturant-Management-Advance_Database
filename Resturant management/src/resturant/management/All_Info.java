 ...
 * @author mahmu
 */
public class All_Info extends javax.swing.JFrame {

    /**
     * Creates new form All_Info
     */
    public All_Info() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(All_Info.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
